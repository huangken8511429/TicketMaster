...
if (!EVENT_ID) {
  throw new Error("EVENT_ID is required. Run: k6 run -e EVENT_ID=<id> scripts/load-test-100k.js");
}
...
export function handleSummary(data) {
  ...
  const timeouts = data.metrics.reservations_timeout
    ...
    : 0;
  const p50 = data.metrics.poll_until_final_ms
    ? data.metrics.poll_until_final_ms.values["p(50)"]
    : "N/A";
  ...
  const reqP50 = data.metrics.http_req_duration
    ? data.metrics.http_req_duration.values["p(50)"]
    : "N/A";
  const reqP95 = data.metrics.http_req_duration
    ? data.metrics.http_req_duration.values["p(95)"]
    : "N/A";
  const reqP99 = data.metrics.http_req_duration
  ...
  summary += `    Req P50: ${typeof reqP50 === "number" ? reqP50.toFixed(0) : reqP50}ms\n`;
  summary += `    Req P95: ${typeof reqP95 === "number" ? reqP95.toFixed(0) : reqP95}ms\n`;
  summary += `    Req P99: ${typeof reqP99 === "number" ? reqP99.toFixed(0) : reqP99}ms\n`;
  summary += `\n  Poll latency (end-to-end per reservation):\n`;
  summary += `    P50: ${typeof p50 === "number" ? p50.toFixed(0) : p50}ms\n`;
